...
4. Band = `central·exp(±MAD)`, MAD = 1.4826 × weighted median-absolute-deviation of the same estimates (**robust σ-equivalent** — one outlier benchmark barely moves it). Single-benchmark node → degenerate `[c,c,c]` box.
